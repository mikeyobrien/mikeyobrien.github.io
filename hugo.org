...
:EXPORT_FILE_NAME: _index
:END:
** Using org-mode to blog
:PROPERTIES:
:EXPORT_FILE_NAME: using-org-mode-to-blog
...
Fortunately the package is included as an option with [[https://github.com/hlissner/doom-emacs][doom-emacs]].
...
#+BEGIN_SRC conf
-#net.ipv4.ip_forward=1 net.ipv4.ip_forward=1 #+END_SRC
